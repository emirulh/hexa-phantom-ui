    ...
    <div className="w-full max-w-[1400px] h-[780px] bg-[#b8b8b8] text-black flex flex-col justify-between overflow-hidden p-4 select-none font-sans mx-auto">
                ...
                <div className="w-full flex-1 flex flex-col xl:flex-row gap-8 items-center justify-between my-auto">
                  <div className="flex-1 flex flex-col items-center justify-center w-full">
                    <div className="w-full max-w-[380px] h-[130px] border-[8px] border-[#22c55e] rounded-[24px] p-2 bg-slate-300/10 shadow-inner flex items-center relative mb-8">
                      <div className="h-full bg-[#22c55e] rounded-[10px] transition-all duration-500 shadow-[0_0_15px_rgba(34,197,94,0.5)]" style={{ width: `${chargeProgress}%` }}></div>
                    </div>
              ...
              <div className="w-full h-full flex flex-col xl:flex-row gap-6 flex-1 overflow-hidden">
                <div className="flex-1 flex flex-col justify-between h-full">
                  <div className="w-full mb-3">
                    <div onClick={() => setActiveState('1.7.1')} className="bg-[#b2c7af]/80 hover:bg-[#b2c7af] transition px-4 py-2.5 rounded-[14px] shadow-sm flex items-center gap-2 font-black text-xs uppercase text-[#0c2d09] cursor-pointer">
                      <Search size={14} /><span>Navigate</span>
                    </div>
                  </div>
                ...
                <div className="w-[340px] shrink-0 flex flex-col justify-between h-full gap-4">
                  <div className="bg-[#d9d9d9] rounded-[17px] shadow-[0_4px_4px_rgba(0,0,0,0.25)] p-4 border border-white/10">
                  ...
                  <button onClick={() => setActiveState('1.1')} className="w-full py-4 bg-[#b2c7af] text-[#0c2d09] font-black text-sm uppercase rounded-xl shadow-[0_4px_4px_rgba(0,0,0,0.15)] mt-auto">Start Route</button>
                </div>
              </div>
            )}
            ...
            {activeState === '1.7.1' && (
              <div className="w-full h-full flex flex-col xl:flex-row gap-6 flex-1 overflow-hidden">
                <div className="flex-1 flex flex-col h-full">
                  <div className="w-full mb-3">
                    <div onClick={() => setActiveState('1.7')} className="bg-[#b2c7af]/80 hover:bg-[#b2c7af] transition px-4 py-2.5 rounded-[14px] shadow-sm flex items-center gap-2 font-black text-xs uppercase text-[#0c2d09] cursor-pointer">
                      <Search size={14} /><span>Home</span>
                    </div>
                  </div>
                  <div className="w-full flex-1 bg-slate-300/40 border border-black/5 rounded-[17px] p-5 shadow-inner overflow-y-auto">
                    <div className="pb-2 border-b border-black/10 mb-4 text-[11px] font-black text-slate-400 uppercase tracking-wider">Recent Destination :</div>
                    <div className="space-y-2.5 font-bold text-sm text-black">
                      <div onClick={() => setActiveState('1.7')} className="p-3 bg-white hover:bg-slate-50 border border-slate-200/60 rounded-xl flex justify-between items-center cursor-pointer shadow-sm transition"><span>📍 Home</span><span className="text-slate-400 text-xs">32km</span></div>
                      <div className="p-3 bg-white/90 rounded-xl flex justify-between items-center shadow-xs"><span>🛒 Supermarket</span><span className="text-slate-400 text-xs">5km</span></div>
                      <div className="p-3 bg-white/90 rounded-xl flex justify-between items-center shadow-xs"><span>🏋 Gym</span><span className="text-slate-400 text-xs">12km</span></div>
                      <div className="p-3 bg-white/90 rounded-xl flex justify-between items-center shadow-xs"><span>💼 Work</span><span className="text-slate-400 text-xs">13km</span></div>
                    </div>
                  </div>
                </div>
                <div className="w-[340px] shrink-0 flex flex-col justify-between h-full gap-4">
                  ...
                  <button className="w-full py-4 bg-[#c8c8c8] text-slate-500 font-black text-sm uppercase rounded-xl cursor-not-allowed mt-auto">Start Route</button>
                </div>
              </div>
            )}
      ...
      <section id="section-footer" className="w-full pb-2 pt-1">
        <div className="bg-[#d9d9d9] rounded-[17px] shadow-[0_4px_4px_rgba(0,0,0,0.25)] px-8 lg:px-24 py-4 flex justify-between items-center min-h-[95px]">
          ...
          <button onClick={() => setActiveState('1.1')} className={`flex flex-col items-center gap-1.5 transition ${activeState === '1.1' ? 'text-black font-black scale-105' : 'text-[#5c5454] opacity-70'}`}>
          ...
          <button onClick={() => setActiveState('1.7')} className={`flex flex-col items-center gap-1.5 transition ${activeState === '1.7' || activeState === '1.7.1' ? 'text-black font-black scale-105' : 'text-[#5c5454] opacity-70'}`}>
            <Compass size={26} />
